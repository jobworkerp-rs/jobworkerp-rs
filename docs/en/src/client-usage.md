...
(If you don't need to encode/decode worker.runner_settings, job.args, and job_result.output, you can also execute using grpcurl. Reference: [proto files](https://github.com/jobworkerp-rs/jobworkerp-rs/blob/main/proto/protobuf/jobworkerp/service/))
