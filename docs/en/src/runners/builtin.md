...
| GRPC | gRPC communication (multi-method) | gRPC unary and server streaming requests | worker.runner_settings: host, port, TLS settings, etc., job.args: method name, request, using: "unary" or "streaming" |
