...
mod tests {
    ...
    fn test_error_type_uri_template_is_match() {
        let template = UriTemplate("http://example.com/{user}/profile".to_string());
        ...
        let multi_param_template = UriTemplate(
        ...
        let error_template = UriTemplate("http-error://{error-type}".to_string());
        ...
        let none_template = UriTemplate("".to_string());
