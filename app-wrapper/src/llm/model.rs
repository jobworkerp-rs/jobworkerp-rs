use jobworkerp_runner::jobworkerp::runner::{llm_runner_settings::IsqType, LlmRunnerSettings};
use anyhow::Result;
...
#[async_trait]
pub trait LLMModelLoader {
    async fn load_model(&self, settings: &LlmRunnerSettings) -> Result<Model> {
            ...
            Some(model_settings) => {
                match model_settings {
                    ...
                    jobworkerp_runner::jobworkerp::runner::llm_runner_settings::ModelSettings::TextModel(
                        ...
                        if let Some(adm) = &settings.auto_device_map {
