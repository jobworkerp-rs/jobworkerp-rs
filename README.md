...
- Real-time result notification (broadcast_results): Result distribution to multiple clients, streaming retrieval (See [streaming.md](manual/en/src/streaming.md) for details)
...
- LLM integration: Text generation and chat with tool calling support (See [llm.md](manual/en/src/llm.md) for details)
- Workflow functionality: Execute multiple jobs in coordination (See [workflow.md](manual/en/src/workflow.md) for details)
...
| LLM | LLM execution (multi-method) | Uses various LLMs via external servers | See [llm.md](manual/en/src/llm.md) for details |
| WORKFLOW | Workflow execution (multi-method) | Executes multiple jobs in defined order | See [workflow.md](manual/en/src/workflow.md) for details |
