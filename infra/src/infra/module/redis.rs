...
use common::infra::redis::RedisClient;
...
impl RedisRepositoryModule {
    pub async fn new_by_env(worker_expire_sec: Option<usize>) -> Self {
    ...
    pub async fn new(config_module: &InfraConfigModule, worker_expire_sec: Option<usize>) -> Self {
...
pub mod test {
    ...
    use common::infra::test::{setup_test_redis_client, setup_test_redis_pool};

    use crate::infra::{
        job::redis::RedisJobRepositoryImpl, job_result::redis::RedisJobResultRepositoryImpl,
