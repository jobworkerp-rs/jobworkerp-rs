...
mod test {
    ...
    use common::infra::test::setup_test_redis_client;
    use infra::infra::{
    ...
    async fn subscribe_worker_changed_test() -> Result<()> {
        ...
        let memory_cache = common::infra::memory::new_memory_cache::<Arc<String>, Vec<Worker>>(
            &common::infra::memory::MemoryCacheConfig {
                num_counters: 10,
                max_cost: 1000000,
                use_metrics: false,
            },
