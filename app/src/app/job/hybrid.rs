...
use common::infra::redis::{RedisClient, UseRedisClient};
use common::util::datetime;
use common::util::option::{Exists, FlatMap};
...
mod tests {
    ...
    async fn create_test_app(
        ...
        let mc_config = common::infra::memory::MemoryCacheConfig {
            num_counters: 10000,
            max_cost: 10000,
            use_metrics: false,
        };
    ...
    async fn test_create_direct_job_complete() -> Result<()> {
        ...
        let jh = tokio::spawn(async move {
            let res = app1
                .enqueue_job(Some(&worker_id1), None, jarg1.clone(), None, 0, 0, 0)
                .await;
